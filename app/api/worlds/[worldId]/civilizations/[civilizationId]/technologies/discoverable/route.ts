import { getDiscoverableTechnologiesService } from "@/lib/services/technology-service";
...
/**
 * What this people could realistically get next, and what is still missing for it. Not the
 * whole list of what it does not know: only what is within reach.
 */
export async function GET(_request: Request, context: Context) {
  try {
    ...
    return ok(await getDiscoverableTechnologiesService(worldId, parsed.data));
  } catch (error) {
