...
const TYPES =
  "settlement_founded,civilization_founded,tech_discovered,famine,conflict,battle,conquest,peace,alliance,notable_death,leadership,unrest,epidemic,settlement_collapse,tribe_extinct";
