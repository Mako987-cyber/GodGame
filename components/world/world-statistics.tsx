...
import type { StatsPoint } from "@/lib/dto";
...
export function WorldStatistics({ worldId }: { worldId: string }) {
  const [table, setTable] = useState(false);
  const query = useQuery({ queryKey: queryKeys.stats(worldId), queryFn: () => api.stats(worldId) });
